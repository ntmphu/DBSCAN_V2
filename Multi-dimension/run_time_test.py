...
def run_parametric_dbscan(j, n, d, O_obs, minpts, eps, threshold, a, c):
  ...
  list_interval = []
  list_sign = []  
  total_compute_z_time_1 = 0
  total_compute_z_time_2 = 0
  while zk < threshold:
    x_zk = a*zk + c
    X_zk = unvec(x_zk, n, d)
    ...
    intersection2, S2 = compute_z_interval_test(j, n, d, O_obs, eps, neps_zk, a, c, zk, minusO_zk, x_zk)
    end_time_2 = time.time()
    total_compute_z_time_2 = (end_time_2 - start_time_2)
    print("result", intersection, total_compute_z_time_1)
    print("result_test", intersection2,total_compute_z_time_2)
    print(np.array_equal(S, S2))
